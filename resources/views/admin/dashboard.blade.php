    ...
    <div class="container mx-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="bg-white rounded-lg shadow p-6">
                ...
                <a href="{{ route('admin.users.index') }}" class="inline-block bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded">
                    Ver todos los usuarios
                </a>
                <a href="{{ route('admin.users.create') }}" class="inline-block bg-green-500 hover:bg-green-600 text-white px-4 py-2 rounded ml-2">
                    Crear Usuario
                </a>
            </div>
